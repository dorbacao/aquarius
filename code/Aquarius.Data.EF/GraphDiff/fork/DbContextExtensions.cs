    ...
    public static class DbContextExtensions
    {
        ...
        public static void UpdateGraph<T>(this DbContext context, T entity, Expression<Func<IUpdateConfiguration<T>, object>> mapping) where T : class
        {
            ...
            try
            {
                ...
                if (existing == null)
                    existing = context.Set<T>().Add(entity);
                else
                {
        ...
        public static void AttachCyclicNavigationProperty(DbContext db, object parent, object child)
        {
            ...
            // Alterado Por Marcus Miris @ 4/Set/2014
            //
            //      O código antigo dava erro quando child object fazia parte de uma herança (TPH, TPC, etc);
            // logo ele não tinha entitySet próprio.
            //
            //  Código antigo:
            //
            ...
            // Código Novo:
            EntitySet entitySet = objectContext.TryGetEntitySet(childType);
        ...
        public static T FindEntityMatching<T>(this DbContext context, T entity, params string[] includes) where T : class
        {
            ...
            return query.SingleOrDefault<T>(lambda);
